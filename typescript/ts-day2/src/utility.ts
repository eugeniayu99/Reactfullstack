// 유틸리티 타입
// 타입스크립트에서 타입 변경을 쉽고 용이하게 하기위한 헬퍼 함수 처럼 유틸리티 타입을 제공한다.
// js 배열을 하면서 for, while으로도 해결이 가능하지만
// forEach, filter, map을 통해 간편하게 해결하는 것 처럼

//유틸리티 타입을 몰라도 인터페이스, 제네릭을 활용해서 타입을 바꿀 수 있지만 유틸리티 타입을 사용하면 훨씬 더 간결한 문법으로 타입을 정의 할 수 있다.
